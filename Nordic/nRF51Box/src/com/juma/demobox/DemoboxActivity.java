...
public class DemoboxActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.magnetometer:
			intent.setClass(DemoboxActivity.this, Speedometer.class);
			break;
		case R.id.barometer:
			intent.setClass(DemoboxActivity.this, BarometerActivity.class);
			break;
		case R.id.cube:
			intent.setClass(DemoboxActivity.this, MotionActivity.class);
			break;
		case R.id.car:
			intent.setClass(DemoboxActivity.this, CarActivity.class);
			break;
		case R.id.rbg:
			intent.setClass(DemoboxActivity.this, RBGActivity.class);
			break;
		case R.id.TRH:
			intent.setClass(DemoboxActivity.this, TemperatureAty.class);
			break;
		}
