...
extern uint32_t LIS2DH12_SET_SELF_TEST_MODE(LIS2DH12_SELF_TEST_MODE mode);
extern uint32_t LIS2DH12_Set_Data_Rate(LIS2DH12_DATA_RAT data_rat);
extern int16_t LIS2DH12_Get_Chan_Data(LIS2DH12_ACC_CHAN chan);
