...
#ifndef __STM32F4XX_CANON_H
#define __STM32F4XX_CANON_H
...
/**
  ...
  */
#define CANON_ADCx                                 ADC1
#define CANON_ADCx_CLK_ENABLE()                  __ADC1_CLK_ENABLE()

#define CANON_ADCx_CHANNEL                       ADC_CHANNEL_8
   
#define CANON_ADCx_GPIO_PORT                       GPIOB
#define CANON_ADCx_GPIO_PIN                        GPIO_PIN_0
#define CANON_ADCx_GPIO_CLK_ENABLE()             __GPIOB_CLK_ENABLE()
#define CANON_ADCx_GPIO_CLK_DISABLE()            __GPIOB_CLK_DISABLE()
/**
  * @}
  */
